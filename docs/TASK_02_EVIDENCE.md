...
- Последний CSV, рекламируемый паспортом: `data-20260901T1609-structure-20260210T1102.csv`.
- Версия файла и возраст публикации переданы в source/pipeline results; на live run
  2026-09-23 возраст даты публикации составлял 22 календарных дня.
