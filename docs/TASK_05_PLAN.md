...
Статус: **DONE_WITH_WARNINGS** (2026-09-24).
...
3. Хранить исходные теги, геометрию, CRS, PBF artifact/release, snapshot hash,
   время репликации PBF и время извлечения. Версию/время отдельного OSM object
   указывать только если GDAL/PBF действительно их предоставляет.
